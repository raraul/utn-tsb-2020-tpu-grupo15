...
//                cad.append("\nLista ").append(i).append(":\n\t").append(this.table[i].toString());
    ...
    private static class Entry<K, V> implements Map.Entry<K, V>
    {
        ...
        {
//            if (key == null) {
//                throw new IllegalArgumentException("Entry(): parámetro 'key' null...");
//            }
//            if (value == null) {
//                throw new IllegalArgumentException("Entry(): parámetro 'value' null...");
//            }
//            if (state == null) {
//                throw new IllegalArgumentException("Entry(): parámetro 'state' null...");
//            }
            this.key = key;
            this.value = value;
            this.state = state;
...
//                System.out.println("\n\n");
//                System.out.println("Comparamos la posición actual con el largo de la tabla.");
//                System.out.println("t.length: " + t.length);
//                System.out.println("actual: " + actual);
//                System.out.println("resultado de la comparación actual >= t.length : " + (actual >= t.length));
//                System.out.println("\n\n");
                // El último elemeno de la lista es t.length-1
...
//                System.out.println("\n\n");
                ...
                System.out.println("\n\n");
                System.out.println("Elemento que está siendo retornado: ");
                System.out.println(t[actual].getClass());
                if (nextEntry == null) {
                    System.out.println("null: es nulo");
                }
                else {
